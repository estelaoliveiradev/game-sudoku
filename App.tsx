...
const App: React.FC = () => {
  ...
  // Using ReturnType<typeof setInterval> instead of NodeJS.Timeout to fix namespace error in browser environment
  ...
  const handleAIHint = async () => {
    ...
    const hint = await getSmartHint(gameState.board, solution);
    if (hint) {
      setHintInfo(hint);
